...
the same happened as 17 my laptop hanged quite badly when i tried to do the mutate function. 
...
my r studio cannot find the count function even though it worked well for qn 19
...
could not find arrange function.
...
# Enter code here
library(dplyr)
hotels%>% filter(adults==0,children>=1)%>%
